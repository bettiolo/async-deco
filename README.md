...
Promisify
---------
Convert a callback based function to a function returning a promise. It is a reference 
to https://www.npmjs.com/package/es6-promisify, exposed here for convenience.
```js
